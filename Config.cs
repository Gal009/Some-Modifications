...
namespace ChorãoUtilities
{
    public sealed class Config : IConfig
    {
        ...
        [Description("The message that appears when someone is dying from decontamination")]
        public string NoobDiedToDecontMessage { get; set; } = "<color=black>You can't breath</color>";
    }
}